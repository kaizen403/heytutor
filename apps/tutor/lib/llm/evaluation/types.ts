...
export type TutorEvaluationJob = "lesson_review" | "notes_routing" | "dsa_teaching" | "visual_need";
...
export interface DsaTeachingState {
  notice: string;
  question: string;
...
export type TutorEvaluationRequest =
  ...
  | { job: "dsa_teaching"; state: DsaTeachingState }
