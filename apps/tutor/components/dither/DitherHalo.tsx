...
/*
 * Mirrored from apps/landing/src/components/dither/DitherHalo.tsx — the two apps share
 * one pixel field, so change both together. The only edits here are the
 * "use client" pragma Next needs and semicolons for this app's lint config.
 */
