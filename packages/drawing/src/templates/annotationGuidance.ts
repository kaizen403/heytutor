...
- examples: object distance below the axis [DIMENSION:u = 30 cm,490,300,610,300,80]; focal length [DIMENSION:f = 15 cm,550,300,610,300,108]; image height beside the arrow [DIMENSION:h',760,300,760,240,-30].
